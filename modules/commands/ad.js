...
"https://media.giphy.com/media/mf4qECoTz8ZVK/giphy.gif",
  ...
  👀 Tên: Trần Ngọc Kiên
  🙄 Sinh ngày: 2/3/4
  💫 Chiều cao / cân nặng: 1m50 / 30kg
  🌸 Cung: Song Ngư
  💘 Mối quan hệ: Độc Toàn Thân  
  🏠 Quê quán: Sao Hỏa  
  🤔 Nơi ở: Trái Đất 
  🌍 Facebook: https://www.facebook.com/tnkleepy04
  📲 Zalo: 0783191903
  📢 Lưu ý cho các qtv và tv trong box: 
- Vui lòng không spam khi sử dụng để tránh die bot
- Không sử dụng lệnh nhiều của lệnh đó
- Đừng chửi bot vì nó sẽ ban bạn đó=))
- Nếu bot bố láo thì đừng ngại report nó nhé ><
- Nếu bot ko hoạt động hay bị lỗi thì liên hệ trực tiếp với mình để fix nhé
--------------[KienTran]--------------`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
