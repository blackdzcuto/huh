...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "add": {
            if (permssion != 2) return api.sendMessage("⚡️ Bạn đéo phải admin =))", threadID, messageID);
        ...
        case 'boxonly': {
            if (permssion != 1) return api.sendMessage("⚡️ Bạn đéo phải admin", threadID, messageID);
        const { resolve } = require("path");
